 ...
 */function normalizePaging(a){if(!a.links.last)return{count:0,pages:0};var b=(0,_parse["default"])(_url["default"].parse(a.links.last).query),c=parseInt(b.page.number,10),d=parseInt(b.page.size,10);return{count:c*d,pages:c}}module.exports=exports.default;