 ...
 */function Collection(a,b){var c=[{data:{items:[]},parameterBag:null,metadata:{loading:!1,loaded:!1,lastParameterBagState:null,paging:{count:null,pages:null}}}],d={get name(){return a},get repository(){return b},get parameterBag(){return _ParameterBag["default"].fromState(c.parameterBag||{})},set parameterBag(a){(0,_State.setState)(c,{parameterBag:a.state})},/**
     * @returns {number}
